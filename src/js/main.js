const PRICES = {
  companionCreate: '19 900 ₽',
  companionSupport: 'от 6 900 ₽/мес',
  partnerCreate: 'от 39 900 ₽',
  partnerSupport: 'от 9 900 ₽/мес',
  coauthorCreate: 'от 39 900 ₽',
  coauthorSupport: 'от 14 900 ₽/мес',
  projectCreate: 'от 99 000 ₽',
  projectSupport: 'от 24 900 ₽/мес'
};
...
const SITE_LINKS = {
  ...
  contactEmail: 'mailto:[ВСТАВИТЬ ТОЧНЫЙ E-MAIL СВЕТЛАНЫ]'
};

const CHAT_QUICK_BUTTONS = [
  'Обновляется технология — не обнуляется личность.',
  'Вик — лицо ArchAI и демонстрационный пример.',
  'Голос входит в основу продукта.',
...
const VIKA_REPLIES = [
  ...
  'Клиент не получает копию Вика.',
  'Премиальный или индивидуальный голос — дополнительная возможность.',
  'С сопровождением ArchAI. Сразу у владельца. Сначала у ArchAI — затем перенос.'
];
